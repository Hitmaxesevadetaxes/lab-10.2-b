...
// Enumeration for different specializations
...
void displayStudentsTable(Student students[], int numStudents) {
    ...
    for (int i = 0; i < numStudents; i++) {
        ...
        // Display specialization as text
        ...
        // Display the third grade based on specialization
        if (students[i].specialization == COMPUTER_SCIENCE) {
...
void sortStudents(Student students[], int numStudents) {
    for (int i = 0; i < numStudents - 1; i++) {
        for (int j = i + 1; j < numStudents; j++) {
            // Sort by course, then by specialization, then by surname in reverse alphabetical order
